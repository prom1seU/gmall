...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("/Users/apple/IdeaProjects/gmall-parent/gmall-mbg" + "/src/main/java");
        gc.setAuthor("Lfy");
        ...
        dsc.setUrl("jdbc:mysql://172.16.237.130:3307/gmall_" + moduleName + "?useUnicode=true&useSSL=false&characterEncoding=utf8");
